export const ptBR = {
  ...
  video: {
    ...
    description: 'Assista ao vídeo para conhecer melhor minha trajetória e experiências.',
  },
  companies: {
    title: 'Empresas',
    description: 'Conheça algumas das empresas com as quais já trabalhei.',
    learnMore: 'Saiba mais',
    mutant: {
      slogan: 'NEVER SETTLE.',
      about: {
        title: 'Sobre a Empresa',
        description: 'A Mutant é uma empresa inovadora focada em desenvolvimento de software e soluções tecnológicas. Com uma cultura única e um ambiente dinâmico, buscamos constantemente novos desafios e oportunidades de crescimento.',
        role: 'Cargo',
        period: 'Período',
  ...
  gallery: {
    ...
    description: 'Conheça um pouco mais sobre minha jornada pessoal e profissional',
    sections: {
      education: {
  ...
  research: {
    ...
    description: 'Explorando e compartilhando conhecimentos sobre desenvolvimento de software, tecnologias web e boas práticas.',
